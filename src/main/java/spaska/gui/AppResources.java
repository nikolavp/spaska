...
public class AppResources extends ResourceBundle {
    ...
    private static final Logger logger = Logger.getLogger(AppResources.class
            .toString());

    public static final String APP_TITLE = "appTitle";
    public static final String APP_NAME = "appName";
    public static final String APP_CERDITS = "appCredits";
    public static final String APP_VERSION = "appVersion";
    public static final String APP_SIZE = "appSize";
    public static final String APP_COPYRIGHT = "appCopyright";
    public static final String APP_ICON = "appIcon";
    public static final String STAT_DIALOG_SIZE = "statisticsDialogSize";
    ...
    protected Object handleGetObject(String key) {
        if (key.endsWith("Size")) {
            ...
            try {
                ...
                e.printStackTrace();
                logger.info("Bad value in key " + key + "="
            ...
            try {
                ...
                e.printStackTrace();
                logger.info("Bad value in key " + key + "="
                        + bundle.getString(key) + ". Exception: " + e);
            }
        }
